...
public class WinButton extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        cmdClose.setPreferredSize(new java.awt.Dimension(40, 40));
        ...
        cmdMi.setPreferredSize(new java.awt.Dimension(40, 40));

        cmdRe.setBackground(new java.awt.Color(67, 199, 51));
        cmdRe.setPreferredSize(new java.awt.Dimension(40, 40));
